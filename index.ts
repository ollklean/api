...
const promotions = Spot.parseContract("./src/services/promotions.ts")
...
const managePromotions = Spot.parseContract("./src/services/accounts/promotions.ts")
...
const api = merge(
  [
    ...
    { oas: JSON.parse(JSON.stringify(Spot.OpenApi3.generateOpenAPI3(promotions)))},
    ...
    { oas: JSON.parse(JSON.stringify(Spot.OpenApi3.generateOpenAPI3(managePromotions)))},
